...
public class LegionOfEarlings extends AbstractCornCreature {

    @SuppressWarnings("unused")
    private static final String TAG = LegionOfEarlings.class.getSimpleName();
    
    public LegionOfEarlings() {
        super("Legion of Earlings", 5, Rarity.AlgebraicRare);
