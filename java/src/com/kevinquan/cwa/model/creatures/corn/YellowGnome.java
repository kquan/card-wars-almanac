...
public class YellowGnome extends AbstractCornCreature {

    @SuppressWarnings("unused")
    private static final String TAG = YellowGnome.class.getSimpleName();
    
    public YellowGnome() {
        super("Yellow Gnome", 0, Rarity.AlgebraicRare);
