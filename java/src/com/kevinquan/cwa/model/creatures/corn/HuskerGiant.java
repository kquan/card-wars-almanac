...
public class HuskerGiant extends AbstractCornCreature {

    @SuppressWarnings("unused")
    private static final String TAG = HuskerGiant.class.getSimpleName();
    
    public HuskerGiant() {
        super("Husker Giant", 5, Rarity.AlgebraicRare);
        mDescription = "+2 Attack for each of your Corn landscapes";
    }
