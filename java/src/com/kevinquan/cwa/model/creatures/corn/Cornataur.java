...
public class Cornataur extends AbstractCornCreature {

    @SuppressWarnings("unused")
    private static final String TAG = Cornataur.class.getSimpleName();
    
    public Cornataur() {
        super(Cornataur.class.getSimpleName(), 4, Rarity.VeryRare);
