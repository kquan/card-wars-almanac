...
public class TimmyMagicEyes extends AbstractPlainsCreature {

    @SuppressWarnings("unused")
    private static final String TAG = TimmyMagicEyes.class.getSimpleName();
    
    public TimmyMagicEyes() {
        super("Timmy Magic Eyes", 0, Rarity.AlgebraicRare);
