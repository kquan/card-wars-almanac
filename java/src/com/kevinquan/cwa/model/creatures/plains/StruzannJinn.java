...
public class StruzannJinn extends AbstractPlainsCreature {

    @SuppressWarnings("unused")
    private static final String TAG = StruzannJinn.class.getSimpleName();
    
    public StruzannJinn() {
        super("Struzann Jinn", 4, Rarity.VeryRare);
