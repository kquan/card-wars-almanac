...
public class Sandfoot extends AbstractSandyCreature {

    @SuppressWarnings("unused")
    private static final String TAG = Sandfoot.class.getSimpleName();
    
    public Sandfoot() {
        super(Sandfoot.class.getSimpleName(), 3, Rarity.Rare);
