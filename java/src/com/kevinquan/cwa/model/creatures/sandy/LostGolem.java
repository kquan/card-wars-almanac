...
public class LostGolem extends AbstractSandyCreature {

    @SuppressWarnings("unused")
    private static final String TAG = LostGolem.class.getSimpleName();
    
    public LostGolem() {
        super("Lost Golem", 5, Rarity.AlgebraicRare);
