...
public class SandKnight extends AbstractSandyCreature {

    @SuppressWarnings("unused")
    private static final String TAG = SandKnight.class.getSimpleName();
    
    public SandKnight() {
        super("Sand Knight", 4, Rarity.VeryRare);
        mDescription = "All of your creatures gain +5 Defense"; // Check
    }
