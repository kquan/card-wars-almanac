...
public class FisherFish extends AbstractRainbowCreature {

    @SuppressWarnings("unused")
    private static final String TAG = FisherFish.class.getSimpleName();
    
    public FisherFish() {
        super("Fisher Fish", 5, Rarity.AlgebraicRare);
