...
public class DetectiveSally extends AbstractRainbowCreature {

    @SuppressWarnings("unused")
    private static final String TAG = DetectiveSally.class.getSimpleName();
    
    public DetectiveSally() {
        super("Detective Sally", 4, Rarity.VeryRare);
        mDescription = "This creature and adjacent creatures gain +6 Defense";
    }
