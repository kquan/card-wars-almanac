...
public class PorcelainGuardian extends AbstractRainbowCreature {

    @SuppressWarnings("unused")
    private static final String TAG = PorcelainGuardian.class.getSimpleName();
    
    public PorcelainGuardian() {
        super("Porcelain Guardian", 5, Rarity.AlgebraicRare);
