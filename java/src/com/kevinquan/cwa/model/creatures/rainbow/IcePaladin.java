...
public class IcePaladin extends AbstractRainbowCreature {

    @SuppressWarnings("unused")
    private static final String TAG = IcePaladin.class.getSimpleName();
    
    public IcePaladin() {
        super("Ice Paladin", 3, Rarity.Rare);
        mDescription = "Adjacent creatures gain +5 Defense"; // Check
    }
