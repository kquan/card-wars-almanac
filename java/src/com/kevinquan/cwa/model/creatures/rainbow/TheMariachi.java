...
public class TheMariachi extends AbstractRainbowCreature {

    @SuppressWarnings("unused")
    private static final String TAG = TheMariachi.class.getSimpleName();
    
    public TheMariachi() {
        super("The Mariachi", 5, Rarity.AlgebraicRare);
        mDescription = "Add +5 Attack to all your creatures"; // Check
    }
