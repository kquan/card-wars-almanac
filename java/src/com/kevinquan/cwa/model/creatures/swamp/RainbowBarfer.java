...
public class RainbowBarfer extends AbstractSwampCreature {

    @SuppressWarnings("unused")
    private static final String TAG = RainbowBarfer.class.getSimpleName();
    
    public RainbowBarfer() {
        super("Rainbow Barfer", 5, Rarity.AlgebraicRare);
