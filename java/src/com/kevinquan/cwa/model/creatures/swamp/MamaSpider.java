...
public class MamaSpider extends AbstractSwampCreature {

    @SuppressWarnings("unused")
    private static final String TAG = MamaSpider.class.getSimpleName();
    
    public MamaSpider() {
        super("Mama Spider", 4, Rarity.VeryRare);
