...
public class DaveyBear extends AbstractSwampCreature {

    @SuppressWarnings("unused")
    private static final String TAG = DaveyBear.class.getSimpleName();
    
    public DaveyBear() {
        super("Davey Bear", 5, Rarity.AlgebraicRare);
        mDescription = "Deal 5 Damage to the opposing creature and Hero"; // Check
    }
