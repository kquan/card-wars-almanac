...
public class CottonsaurusRex extends AbstractNiceCreature {

    @SuppressWarnings("unused")
    private static final String TAG = CottonsaurusRex.class.getSimpleName();
    
    public CottonsaurusRex() {
        super("Cottonsaurus Rex", 5, Rarity.AlgebraicRare);
