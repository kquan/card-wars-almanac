...
public class DetectiveBobby extends AbstractNiceCreature {

    @SuppressWarnings("unused")
    private static final String TAG = DetectiveBobby.class.getSimpleName();
    
    public DetectiveBobby() {
        super("Detective Bobby", 3, Rarity.Rare);
